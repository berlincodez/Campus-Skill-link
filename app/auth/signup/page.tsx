    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader className="space-y-2">
          <CardTitle className="text-3xl font-bold text-[#3D1A5C]">Join Wynk</CardTitle>
          <CardDescription className="text-lg text-[#4A2066]">
        ...
        <CardContent>
          ...
          <div className="mt-4 text-center text-base text-[#4A2066]">
            ...
            <Link href="/auth/login" className="text-[#3D1A5C] font-bold hover:underline">
              Login
            </Link>
          </div>
        </CardContent>
