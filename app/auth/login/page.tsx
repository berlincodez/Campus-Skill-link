    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-2">
          <CardTitle className="text-3xl font-bold text-[#3D1A5C]">Welcome Back</CardTitle>
          <CardDescription className="text-lg text-[#4A2066]">Login to Wynk</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleLogin} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="text-base text-[#3D1A5C] placeholder:text-[#3D1A5C]/70"
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="text-base text-[#3D1A5C]"
              />
            </div>
          ...
          <div className="mt-4 text-center text-base text-[#4A2066]">
            ...
            <Link href="/auth/signup" className="text-[#3D1A5C] font-bold hover:underline">
              Sign up
            </Link>
          </div>
        </CardContent>
