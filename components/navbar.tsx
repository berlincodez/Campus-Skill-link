...
export function Navbar() {
      ...
      <header className="sticky top-0 z-30 border-b bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            <Image src="/placeholder-logo.svg" width={24} height={24} alt="SkillLink" />
  ...
  return (
    <header className="sticky top-0 z-30 border-b bg-background/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        <div className="flex items-center gap-3">
          {/* Burger menu next to logo, always visible */}
            ...
            <Drawer direction="left">
              ...
              <DrawerContent className="p-0 w-64 h-full flex flex-col">
                <div className="flex flex-col gap-2 p-6 flex-1">
                  ...
                  <Link href="/my-posts" className="py-2 px-2 rounded hover:bg-muted text-primary font-medium">My Posts</Link>
                  <Link href="/my-groups" className="py-2 px-2 rounded hover:bg-muted text-primary font-medium">My Groups</Link>
                </div>
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => router.push("/my-posts")}>My Posts</DropdownMenuItem>
              <DropdownMenuSeparator />
