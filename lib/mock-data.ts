...
const posts: Post[] = [
  {
    ...
    description:
      "Experienced in React and Node.js. Offering weekly tutoring sessions for beginners.",
  ...
  },
  {
    ...
    description:
      "Looking for a native Spanish speaker for conversation practice. All levels welcome.",
    category: "Languages",
    department: "Arts",
  ...
  },
  {
    ...
    description:
      "Seeking collaborators for a branding project. Figma and Adobe skills preferred.",
    category: "Design",
    department: "Arts",
    location: "Design Lab",
    createdAt: seedNow(),
  ...
  },
  {
    ...
    description:
      "Helping juniors prepare for tech interviews. Mock interviews and feedback.",
    category: "Programming",
    department: "Computer Science",
    location: "Online",
    createdAt: seedNow(),
...
export function listPosts(filters: Filters): Post[] {
  ...
  if (filters.department)
    out = out.filter((p) => p.department === filters.department);
  if (filters.q) {
